...
- **Visualizer** (`index.html`) — A rotating 3D Earth with live satellite positions. Toggle groups (Space Stations, GPS, Galileo, Starlink, Weather), hover any point to see its name and altitude, and speed up time from real time to 3600x to watch orbits sweep around the planet.
